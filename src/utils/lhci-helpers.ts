...
export async function getLinks(resultsPath: string) {
...
export async function getAssertionResults(resultsPath: string) {
...
export async function getManifest(resultsPath: string) {
